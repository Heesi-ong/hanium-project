...
PURPOSES = {
    "class": {
        ...
        "coaching_direction": "개념 정확성, 이해하기 쉬운 설명, 근거 자료를 우선한다.",
    ...
    "project": {
        ...
        "coaching_direction": "문제 정의, 해결 과정, 검증 결과, 본인 기여도를 우선한다.",
    ...
    "interview": {
        ...
        "coaching_direction": "구체적인 경험, 역할, 행동, 결과, 직무 연관성을 우선한다.",
    ...
    "business": {
        ...
        "coaching_direction": "현황, 원인, 위험, 의사결정 사항, 다음 행동을 우선한다.",
    ...
    "sales": {
        ...
        "coaching_direction": "고객 문제, 제안 가치, 차별점, 검증 지표, 다음 행동을 우선한다.",
